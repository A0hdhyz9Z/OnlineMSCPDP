...
//        String paramsORB=args[6];
        ...
        /*** OOB ***/
        String task = "CpjitsdpFiltering0  -l (meta.ggc2.meta.WaitForLabelsOOB -i 15 -s " + ens + " -t " + theta + " -w " + waitingTime + ")  -s  (ArffFileStream -f (datasets/" + datasetsArray[dsIdx] + ".arff) -c 15) -e (FadingFactorEachClassPerformanceEvaluator -a 0.99) -f 1 -d results/" + datasetsArray[dsIdx] + "-Filter-OOB-" + filterParams.replaceAll(";", "-") + "-" + arrId + ".csv";

        /*** ORB ***/
        String task2 = "CpjitsdpFiltering3 -l (spdisc.meta.WFL_OO_ORB_Oza -i 15 -s " + ens + " -t " + theta + " -w " + waitingTime + " -p " + paramsORB + ")  -s  (ArffFileStream -f (datasets/" + datasetsArray[dsIdx] + ".arff) -c 15) -e (FadingFactorEachClassPerformanceEvaluator -a 0.99) -f 1 -d results/" + datasetsArray[dsIdx] + "-Filter-ORB-(" + paramsORB.replaceAll(";", "-") + ")-" + filterParams.replaceAll(";", "-") + "-" + arrId + ".csv";
